...
public class Human extends AbstractHuman {
    ...
    public static void think(String name1, String name5, String place1) {
        System.out.println("Сперва " + name1 + " подумал, что " + name5 + " взлетел на воздух,потом " + name1 + " подумал, что, может быть, только их любимый " + place1 + ";");
    }


    public static void fly(String name1, String place2, String name2, String name3, String name4){
        System.out.println("ещё потом-- что, может быть, только " + name1 + ", взлетел и сейчас " + name1 + " один-одинешенек лежит где-нибудь на " + place2 + " и никогда-никогда не увидит больше ни " + name2 + ", ни " + name3 + ", ни " + name4 + "...");
    }
